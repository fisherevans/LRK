...
public interface ConfigurableEffect extends Effect {
	/**
	 * Returns the list of {@link org.newdawn.slick.font.effects.ConfigurableEffect.Value}s for this effect. This list is not typically backed by the effect, so changes to the
	 * values will not take affect until {@link #setValues(java.util.List)} is called.
	 */
	public List getValues();

	/**
	 * Sets the list of {@link org.newdawn.slick.font.effects.ConfigurableEffect.Value}s for this effect.
	 */
