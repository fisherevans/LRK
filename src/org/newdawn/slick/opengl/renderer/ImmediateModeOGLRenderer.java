...
public class ImmediateModeOGLRenderer implements SGL {
	...
	/**
	 * @see SGL#glClipPlane(int, java.nio.DoubleBuffer)
	 */
	...
	/**
	 * @see SGL#glDeleteTextures(java.nio.IntBuffer)
	 */
	...
	/**
	 * @see SGL#glGetFloat(int, java.nio.FloatBuffer)
	 */
	...
	/**
	 * @see SGL#glGetInteger(int, java.nio.IntBuffer)
	 */
	...
	/**
	 * @see SGL#glGetTexImage(int, int, int, int, java.nio.ByteBuffer)
	 */
	...
	/**
	 * @see SGL#glReadPixels(int, int, int, int, int, int, java.nio.ByteBuffer)
	 */
