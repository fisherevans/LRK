...
public class PNGImageData implements LoadableImageData {
     ...
     * @throws java.io.IOException Indicates a failure to read appropriate data from the stream
     */
     ...
     * @throws java.io.IOException Indicates a failure to read the PNG either invalid data or
     ...
     * @throws java.io.IOException Indicates a failure to unfilter the data due to an unknown
     * filter type
     */
     ...
     * 
     * @throws java.io.IOException Indicates a failure to read the header
     */
     ...
     * 
     * @throws java.io.IOException Indicates a failure to fully read the chunk
     */
     ...
     * 
     * @throws java.io.IOException Indicates a failure to determine chunk information from the stream
     */
     ...
     * @throws java.io.IOException Indicate a failure to read data or a different chunk on the stream
     */
     ...
     * @throws java.io.IOException Indicate an invalid size
     */
     ...
     * @throws java.io.IOException Indicate a failure to read the appropriate data from the chunk
     */
     ...
     * @throws java.io.IOException Indicates there is no more data left or invalid data has been found on
     * the stream.
     */
     ...
     * @throws java.io.IOException Indicates a failure to read the complete chunk
     */
     ...
     * @throws java.io.IOException Indicates a failure to access the data
     */
