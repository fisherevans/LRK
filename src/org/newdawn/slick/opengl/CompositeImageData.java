...
public class CompositeImageData implements LoadableImageData  {
	...
	/**
	 * @see LoadableImageData#loadImage(java.io.InputStream)
	 */
	...
	/**
	 * @see LoadableImageData#loadImage(java.io.InputStream, boolean, int[])
	 */
	...
	/**
	 * @see LoadableImageData#loadImage(java.io.InputStream, boolean, boolean, int[])
	 */
